...
7. 🔮 F16 - Camera Die Focus Click (new)
8. 🔮 F05/F10/F06/F07/F08/F09 - Screen Architecture expansion
...
4. **Start F16 (Camera Die Focus Click):** Click-to-zoom on individual dice with raycast + smooth retarget.
5. Start F05/F10 when TB core loop is stable enough for screen-shell work.
