...
const STONE_MINERAL_MATERIALS = new Set<DieBodyMaterial>([
    'stone',
    'obsidian',
    'jade',
    'marble',
...
type StoneMineralMaterial = Extract<DieBodyMaterial, 'stone' | 'obsidian' | 'jade' | 'marble' | 'granite'>;
...
function resolveSurfaceProfile(bodyMaterial: DieBodyMaterial, surfaceFinish: DieSurfaceFinish): DieMaterialPreset['surface'] {
    ...
    if (STONE_MINERAL_MATERIALS.has(bodyMaterial)) {
        return {
            ...baseProfile,
            ...STONE_MINERAL_SURFACE_OVERRIDES[bodyMaterial as StoneMineralMaterial][surfaceFinish],
        };
    }
